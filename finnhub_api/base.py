...
from finnhub_api.decorators import ohlcv_frame, economic_data_frame
from finnhub_api.utils import get_formatted_dates
...
class FinnHubBase(object):
    ...
    def quote(self, symbol):
        ...
        quote = self.call_api('/quote', params={'symbol': symbol})

        return pd.Series({index_names[k]: quote[k] for k in quote}, dtype=float)
